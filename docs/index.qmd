...
p1 <- local({
  ...
  names(posterior) <- c("Intercept", "Age (+1 SD)", "Sex:\n(Female) - (Male)", "University:\n(Aysén) - (Magallanes)", "Study area:\n(Healthcare) - (Engineer)", "Study area:\n(Social Sciences) - (Engineer)", "Alcohol:\n(No) - (Yes)", "Tobaco:\n(No) - (Yes)", ".chain", ".iteration", ".draw")
  posterior <-as.data.table(posterior) |> 
    melt(id.vars = c(".chain", ".iteration", ".draw"))
  posterior[!grepl("Intercept", variable)]
}) |> 
  ggplot(aes(value, variable)) +
  stat_halfeye(aes(fill = after_stat(abs(x) > 0.18)), show.legend = FALSE) +
  geom_vline(xintercept = c(-0.18, 0.18), alpha = .5) +
  scale_y_discrete(expand = c(0,.1)) +
  ggsci::scale_fill_jama() +
  labs(y = NULL, x = "Log-odds", title = "Functional impact of pain") +
  theme_classic()
...
p2 <- local({
  ...
  scale_y_discrete(expand = c(0,.1)) +
  ggsci::scale_fill_jama() +
  labs(y = NULL, x = "Log-odds", title = "Percieved pain intensity") +
  theme_classic()

p3 <- local({
  posterior <- mc3_factores |> 
    as_draws_df(variable = "^b", regex = T)
  names(posterior) <- c("Intercept [1]", "Intercept [2]", "Intercept [3]", "Intercept [4]", "Age (+1 SD)", "Sexo:\n(Female) - (Male)", "University:\n(Aysén) - (Magallanes)", "Study area:\n(Healthcare) - (Engineer)", "Study area:\n(Social Sciences) - (Engineer)", "Alcohol:\n(No) - (Yes)", "Tabaco:\n(No) - (Yes)", ".chain", ".iteration", ".draw")
  posterior <- as.data.table(posterior) |> 
    melt(id.vars = c(".chain", ".iteration", ".draw"))
  posterior[!grepl("Intercept", variable)]
}) |> 
  ...
  scale_y_discrete(expand = c(0,.1)) +
  ggsci::scale_fill_jama() +
  labs(y = NULL, x = "Log-odds", title = "Reported pain frequency") +
  theme_classic()

p4 <- local({
  posterior <- mc4_factores |> 
    as_draws_df(variable = "^b", regex = T)
  names(posterior) <- c("Intercept", "Age (+1 SD)", "Sex:\n(Female) - (Male)", "University:\n(Aysén) - (Magallanes)", "Study area:\n(Healthcare) - (Engineer)", "Study area:\n(Administrative) - (Engineer)", "Study area:\n(Social Sciencies) - (Engineer)", "Alcohol:\n(No) - (Yes)", "Tabaco:\n(No) - (Yes)", ".chain", ".iteration", ".draw")
  posterior <- as.data.table(posterior) |> 
    melt(id.vars = c(".chain", ".iteration", ".draw"))
  posterior[!grepl("Intercept", variable)]
}) |> 
  ...
  scale_y_discrete(expand = c(0,.1)) +
  ggsci::scale_fill_jama() +
  labs(y = NULL, x = "Log-odds", title = "Prevalence of persistent pain") +
  theme_classic()

fig1 <- ggpubr::ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2, align = "hv")

ggsave(filename = "docs/fig1.png", fig1, "png", width = 10, height = 8, units = "in", dpi = 500)
...
p1 <- local({
  ...
  names(posterior) <- c("IPAQ:\n(Moderate) - (Low)", "IPAQ:\n(High) - (Low)", ".chain", ".iteration", ".draw")
  posterior <-as.data.table(posterior) |> 
    melt(id.vars = c(".chain", ".iteration", ".draw"))
  posterior[!grepl("Intercept", variable)]
}) |> 
...
fig2 <- ggpubr::ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2, align = "hv")

ggsave(filename = "docs/fig2.png", fig2, "png", width = 10, height = 8, units = "in", dpi = 500)
...
p1 <- local({
  ...
  names(posterior) <- c("Total METs (+1 SD)", ".chain", ".iteration", ".draw")
  posterior <-as.data.table(posterior) |> 
    melt(id.vars = c(".chain", ".iteration", ".draw"))
  posterior[!grepl("Intercepto", variable)]
}) |> 
...
fig3 <- ggpubr::ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2, align = "hv")

ggsave(filename = "docs/fig3.png", fig3, "png", width = 10, height = 8, units = "in", dpi = 500)
...
p1 <- local({
  ...
  names(posterior) <- c("(Moderate evening) - (Extreme evening)", "(Intermediate) - (Extreme evening)", "(Moderate morning) - (Extreme evening)", ".chain", ".iteration", ".draw")
  posterior <-as.data.table(posterior) |> 
    melt(id.vars = c(".chain", ".iteration", ".draw"))
  posterior[!grepl("Intercept", variable)]
}) |> 
...
fig4 <- ggpubr::ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2, align = "hv")

ggsave(filename = "docs/fig4.png", fig4, "png", width = 10, height = 8, units = "in", dpi = 500)
...
p1 <- local({
  ...
  names(posterior) <- c("Matutinity score (+1 SD)", ".chain", ".iteration", ".draw")
  posterior <-as.data.table(posterior) |> 
    melt(id.vars = c(".chain", ".iteration", ".draw"))
  posterior[!grepl("Intercept", variable)]
}) |> 
...
fig5 <- ggpubr::ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2, align = "hv")

ggsave(filename = "docs/fig5.png", fig5, "png", width = 10, height = 8, units = "in", dpi = 500)
...
fig6 <- ggpubr::ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2, align = "hv")

ggsave(filename = "docs/fig6.png", fig6, "png", width = 10, height = 8, units = "in", dpi = 500)
...
p1 <- local({
  ...
  names(posterior) <- c("Sleep duration (+1 SD)", ".chain", ".iteration", ".draw")
  posterior <-as.data.table(posterior) |> 
    melt(id.vars = c(".chain", ".iteration", ".draw"))
  posterior[!grepl("Intercept", variable)]
}) |> 
...
fig7 <- ggpubr::ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2, align = "hv")

ggsave(filename = "docs/fig7.png", fig7, "png", width = 10, height = 8, units = "in", dpi = 500)
